...
if input:match("^[#!/][Jj]ove$") and is_mod(msg) or input:match("^[Jj]ove$") and is_mod(msg) or input:match("^ژوپیتر$") and is_mod(msg) then
        local text = "🏅 اطلاعات دیزاین تیم: \n"
	.."رباتي قدرتمند جهت مديريت سوپرگروه: \n"
        ...
        .."🏅  ديباگ شده و قدرتمند \n"
        .."🏅  ويرايش و ارتقا: @Haji_tonam \n"
        .."🏅  کانال رسمي: @Design_Groups \n"
        .."🏅  پيام رسان: @Bot_mebot \n"
        .."🏅 سرور: #Hetzner \n"
        .."🏅 رم: 16Gig \n"
        .."🏅 پشتيباني: @Bot_mebot \n"
